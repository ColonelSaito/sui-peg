        ...
        <div className="max-w-4xl mx-auto">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 pb-2">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-green-400">0 USDC</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 pb-2">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-green-400">0 SUI</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="mt-12 bg-gray-800/30 border border-gray-700 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-800 p-4 rounded-lg">
                <div className="text-sm text-gray-400 mb-1">Depeg Tokens Issued</div>
